// Native-Windows bridge for the C18A Python guard.  The child exit code comes
...
const result = await run('wsl.exe', ['-d', 'Ubuntu-22.04', '--cd',
  ...
  'fetch_cbo_baseline.py', '--test']);
process.stdout.write(result.stdout);
process.stderr.write(result.stderr);
console.log(`C18A_PYTHON_EXIT fetch_cbo_baseline.py=${String(result.code)}`);
